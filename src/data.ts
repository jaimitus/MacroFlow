...
export const DEFAULT_FLOWS: Flow[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'a3_cond', kind: 'ai_condition', category: 'action', label: 'AI Is Big Invoice?', x: 700, y: 100, config: { provider: 'auto', model: 'llama3.2', question: 'Is this invoice total > 100? Answer true or false: {OCR_TEXT}', then: 'a4_true', else: 'a4_false' }, color: '#D83B01', icon: 'branch' },
